# Generated by Django 4.2 on 2023-06-01 09:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('miqdor', models.PositiveSmallIntegerField(max_length=70)),
                ('olchov', models.CharField(choices=[('dona', 'dona'), ('kg', 'kg'), ('qop', 'qop'), ('blok', 'blok'), ('litr', 'litr')], max_length=30)),
